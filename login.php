        ...
        <section class="clean-block clean-form dark">
            <div class="container">
                <div class="block-heading">
                    <h2 class="text-info">Accede a tu cuenta</h2>
                    <p>Hola de nuevo! Por favor ingresa tu datos para iniciar sesión.</p>
                </div>
                <form action="check-login.php" method="POST"> 
                    ...
                    <div class="form-group">
                        <div class="form-check"><input class="form-check-input" type="checkbox" id="checkbox"><label class="form-check-label" for="checkbox">Recuérdame</label></div>
                    </div>
